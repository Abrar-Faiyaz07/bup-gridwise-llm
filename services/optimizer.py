...
- solar_reduction: Reduces available solar generation by a fraction factor over specified hours.
- minimum_battery_reserve: Raises minimum battery reserve to minimum_energy_kwh over specified hours.
